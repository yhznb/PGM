...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
LogNewValue=LogProbOfJointAssignment(F, A_prop)

LogOldValue=LogProbOfJointAssignment(F,A)

diff=LogNewValue-LogOldValue
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
R_ratio=LogR(old_value)-LogR(new_value)

Q_ratio=R_ratio+log_QY_ratio

p_acceptance=min(1,exp(diff+Q_ratio))
