...
genotypeFactor.var(1)=genotypeVar
...
[m,n]=size(allelesToGenotypes)
for i=1:m
  for j=1:n
   
   genotypeFactor.val(allelesToGenotypes(i,j))=genotypeFactor.val(allelesToGenotypes(i,j))+alleleFreqs(i)*alleleFreqs(j)
